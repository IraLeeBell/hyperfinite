---
name: Adaptive Delivery Guided Synthesis
description: Synthesizes accepted predecessor artifacts without expanding their authority or scope.
on:
  slash_command:
    name: adaptive-delivery-guided-synthesis
  ...
  steps:
    ...
    - name: Authorize solution design before model execution
      ...
      env:
        ...
        RUNTIME_STAGE_ID: guided-synthesis
        RUNTIME_CAPABILITY: demo.adaptive-delivery.guided-synthesis@1.0.0
        RUNTIME_WORKFLOW_ID: adaptive-delivery-guided-synthesis
...
engine:
  id: copilot
  agent: adaptive-delivery-guided-synthesis
  max-continuations: 1
  concurrency:
    group: gh-aw-copilot-adaptive-delivery-guided-synthesis
network: {}
tools:
  github:
    toolsets: [issues]
...
skills:
  - .github/skills/adaptive-delivery-guided-synthesis
...
Use `adaptive-delivery-guided-synthesis` and `authority-refusal`. Produce one target-free design decision traced to every stable acceptance criterion and only the trusted logical slots in the activation context.
