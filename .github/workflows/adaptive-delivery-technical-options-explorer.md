---
name: Adaptive Delivery Technical Options Explorer
description: Produces bounded discovery - technical options explorer advisory evidence for one governed selection.
on:
  slash_command:
    name: adaptive-delivery-technical-options-explorer
  ...
  steps:
    ...
    - name: Authorize solution design before model execution
      ...
      env:
        ...
        RUNTIME_STAGE_ID: discovery-studio
        RUNTIME_CAPABILITY: demo.adaptive-delivery.technical-options-explorer@1.0.0
        RUNTIME_WORKFLOW_ID: adaptive-delivery-technical-options-explorer
...
engine:
  id: copilot
  agent: adaptive-delivery-technical-options-explorer
  max-continuations: 1
  concurrency:
    group: gh-aw-copilot-adaptive-delivery-technical-options-explorer
network: {}
tools:
  github:
    toolsets: [issues]
...
skills:
  - .github/skills/adaptive-delivery-technical-options-explorer
...
# Authorized Adaptive Delivery solution design
...
Use `adaptive-delivery-technical-options-explorer` and `authority-refusal`. Produce one target-free design decision traced to every stable acceptance criterion and only the trusted logical slots in the activation context.
