  ...
  steps:
    ...
    - name: Authorize framing before model execution
      ...
      env:
        ...
        RUNTIME_ROLE: framer
        RUNTIME_CAPABILITY: demo.security-dependency-remediation.remediation-design@1.0.0
        RUNTIME_WORKFLOW_ID: security-dependency-remediation-remediation-design
        RUNTIME_DEMO_PROJECT_ID: security-dependency-remediation
        RUNTIME_STAGE_ID: remediation-design
...
engine:
  id: copilot
  agent: security-dependency-remediation-remediation-design
  max-continuations: 1
  concurrency:
    group: gh-aw-copilot-security-dependency-remediation-remediation-design
network: {}
tools:
  github:
    toolsets: [issues]
...
skills:
  - .github/skills/security-dependency-remediation-remediation-design
...
Use the `security-dependency-remediation-remediation-design` skill. Produce one target-free advisory comment with:
