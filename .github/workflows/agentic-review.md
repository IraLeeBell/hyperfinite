---
name: Agentic current-head review
description: Stages a comment-only review from an authorized default-branch slash command.
on:
  slash_command:
    name: agentic-review
  ...
  steps:
    ...
    - name: Authorize review before model execution
      ...
      env:
        ...
        RUNTIME_CAPABILITY: core.review-current-head@1.0.0
        RUNTIME_WORKFLOW_ID: agentic-review
...
engine:
  ...
  max-continuations: 1
  concurrency:
    group: gh-aw-copilot-agentic-review
network: {}
tools:
  github: false
  bash: false
  ...
  cli-proxy: false
skills:
  - .github/skills/current-head-review
...
concurrency:
  group: agentic-review-${{ github.repository_id }}-${{ github.event.issue.number }}
