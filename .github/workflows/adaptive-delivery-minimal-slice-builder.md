  ...
  steps:
    ...
    - name: Authorize Adaptive Delivery build before model execution
      ...
      env:
        ...
        RUNTIME_CAPABILITY: demo.adaptive-delivery.minimal-slice-builder@1.0.0
        RUNTIME_WORKFLOW_ID: adaptive-delivery-minimal-slice-builder
    ...
    - name: Transfer the trusted execution authorization
      ...
      with:
        name: adaptive-delivery-minimal-slice-builder-authorization-${{ github.run_id }}-${{ github.run_attempt }}
...
engine:
  id: copilot
  agent: adaptive-delivery-minimal-slice-builder
  max-continuations: 1
  concurrency:
    group: gh-aw-copilot-adaptive-delivery-minimal-slice-builder
network: {}
tools:
  github: false
skills:
  - .github/skills/adaptive-delivery-minimal-slice-builder
    ...
    stage-implementation-patch:
      ...
      steps:
        ...
        - name: Transfer the signed trusted execution bundle
          ...
          uses: actions/upload-artifact@v7
          with:
            name: adaptive-delivery-minimal-slice-builder-bundle-${{ github.run_id }}-${{ github.run_attempt }}
        ...
        - name: Invoke the trusted execution delivery service
          ...
          env:
            ...
            TRUSTED_EXECUTION_ARTIFACT_NAME: adaptive-delivery-minimal-slice-builder-bundle-${{ github.run_id }}-${{ github.run_attempt }}
