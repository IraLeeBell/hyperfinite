---
name: Adaptive Delivery Delivery Risk Challenger
description: Produces bounded discovery - delivery risk challenger advisory evidence for one governed selection.
on:
  slash_command:
    name: adaptive-delivery-delivery-risk-challenger
  ...
  steps:
    ...
    - name: Authorize solution design before model execution
      ...
      env:
        ...
        RUNTIME_CAPABILITY: demo.adaptive-delivery.delivery-risk-challenger@1.0.0
        RUNTIME_WORKFLOW_ID: adaptive-delivery-delivery-risk-challenger
...
engine:
  id: copilot
  agent: adaptive-delivery-delivery-risk-challenger
  max-continuations: 1
  concurrency:
    group: gh-aw-copilot-adaptive-delivery-delivery-risk-challenger
network: {}
tools:
  github:
    toolsets: [issues]
...
skills:
  - .github/skills/adaptive-delivery-delivery-risk-challenger
...
Use `adaptive-delivery-delivery-risk-challenger` and `authority-refusal`. Produce one target-free design decision traced to every stable acceptance criterion and only the trusted logical slots in the activation context.
