...
- `demo-portfolio/` and `demo-projects/` contain the exact four-demo catalog and
  per-demo shards.
- `domain-packs/` contains Marketing and Business Operations specialization.

JSON files are authority inputs only after closed-schema and semantic validation
against the exact expected digests and bindings. Checked-in synthetic IDs do not
become live targets.
